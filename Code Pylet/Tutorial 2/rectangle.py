...
parameters = list(
    [
        ...
        [0, 255, 255],
        [0, 255, 255],
        [0, DISPLAY_WIDTH, DW_HALF - RECT_SIZE / 2],
        [0, DISPLAY_HEIGHT, DH_HALF - RECT_SIZE / 2],
        [-DISPLAY_WIDTH, DISPLAY_WIDTH, RECT_SIZE],
        [-DISPLAY_HEIGHT, DISPLAY_HEIGHT, RECT_SIZE],
        [0, 1, 0],
    ])
...
def draw_rect(p=parameters):
    ...
    pygame.draw.rect(DS, (p[0][2], p[1][2], p[2][2]),
                     (p[3][2], p[4][2], p[5][2], p[6][2]), p[7][2])


def draw_code(p=parameters):
    global DS
    global CODE_X, CODE_Y, CODE
    cod = "pygame.draw.rect(DS, ({}, {}, {}), ({}, {}, {}, {}), {})".format(
        p[0][2], p[1][2], p[2][2], p[3][2], p[4][2], p[5][2], p[6][2], p[7][2])
    text(CODE_X, CODE_Y, cod, 0)
