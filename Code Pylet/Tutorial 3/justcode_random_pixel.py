# This script will draw randomly colored pixels on the display surface at random coordinates
...
while True:
    ...
    # choose some random coordinates within the dimensions of the display surface
    x = random.randint(0, DISPLAY_WIDTH - 1)
    y = random.randint(0, DISPLAY_HEIGHT - 1)

    # draw the pixel to the display surface with the choosen color
    DS.set_at((x, y), rgb)
